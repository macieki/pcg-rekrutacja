        ...
        <v-card elevation="8" class="pa-4">
          <v-card-title class="justify-center">
            <div class="text-center">
              <v-icon color="primary" size="64">mdi-login</v-icon>
              <h2 class="mt-2">Witamy z powrotem</h2>
              <p class="text-subtitle-1 grey--text">
                Zaloguj się, aby kontynuować swoją aplikację
              </p>
            </div>
          </v-card-title>
            ...
            <v-form ref="form" v-model="valid" @submit.prevent="handleLogin">
              ...
              <div class="d-flex justify-space-between align-center mb-4">
                <v-checkbox
                  ...
                  hide-details
                ></v-checkbox>
                <a href="#" @click.prevent class="text-caption primary--text">
                  Nie pamiętasz hasła?
                </a>
              </div>
          ...
          <v-card-text class="text-center">
            <span class="grey--text">Nie masz konta?</span>
            <v-btn
              text
              color="primary"
  ...
  methods: {
    async handleLogin() {
      ...
      try {
        ...
        this.error = err.message || 'Logowanie nie powiodło się'
      } finally {
        this.loading = false
      }
    }
